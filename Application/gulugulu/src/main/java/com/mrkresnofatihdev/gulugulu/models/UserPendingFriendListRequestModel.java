...
public class UserPendingFriendListRequestModel implements IJsonSerializable {
    private String username;
    private String startCreatedAt;
    private int pageSize;

    public UserPendingFriendListRequestModel() {
    }

    public UserPendingFriendListRequestModel(String username, String startCreatedAt, int pageSize) {
