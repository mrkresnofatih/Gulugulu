...
public class UserProfileController {
    ...
    @PostMapping("/get")
    public ResponseEntity<ResponseModel<UserProfileGetResponseModel>> GetUserProfile(@RequestBody UserProfileGetRequestModel userProfileGetRequest) {
        var userProfile = userProfileService.GetUserProfile(userProfileGetRequest);
        return ResponseHelper.BuildOkResponse(userProfile);
    }

    @PostMapping("/update")
    public ResponseEntity<ResponseModel<UserProfileGetResponseModel>> UpdateUserProfile(@RequestBody UserProfileUpdateRequestModel userProfileUpdateRequest) {
